...
#define MISSION_3_DEFAULT_WIDTH_MARGIN 10
#define MISSION_3_DEFAULT_WIDTH 40
#define MISSION_3_DEFAULT_HEIGHT_OFFSET 65
#define MISSION_3_DEFAULT_BOMB_THRESHOLDS 5
#define MISSION_3_DEFAULT_LINE_THRESHOLDS 100
#define MISSION_3_DEFAULT_AVOID_BOMB_RANGE 10
