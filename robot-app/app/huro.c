...
//                                                                                         ? 50 : -50));
                        state = default_set_straight_and_center1(fpga_videodata, LEFT, WIDTH_CENTER + 30, HEIGHT - 4, BLACK, DEFAULT_CENTER_DISTANCE + 25);
                        if (state == 1) {
                            ++step;
                        }
#else
//                        step += mission_3_set_straight(fpga_videodata);
                        step += default_set_straight_and_center1(fpga_videodata, LEFT, WIDTH_CENTER + 30, HEIGHT - 4, BLACK, DEFAULT_CENTER_DISTANCE + 10);
#endif
                        break;
                    case 5:
                        flag = 0;
...
//                            RobotSleep(1);
                    ...
                    case 4:
                        ...
                        state = mission_3_set_straight_and_center1_long(fpga_videodata, (WIDTH_CENTER) - (mission_3_4_getMDir() == LEFT ? 40 : -40));
                        if (state == 1) {
                            ++step;
                        } else if (state == -1) {
                            mission_3_inverse_mdir();
                ...
                switch (step) {
                    ...
                    case 1:
                        ...
                        step = mission_3_default_watch_below(fpga_videodata, 12) &&
                    ...
                    case 2:
                        ...
                        state = mission_3_set_straight(fpga_videodata);
                        if (state == 1) {
                            --step;
                        } else if (state == -1) {
                            mission_3_inverse_mdir();
                    ...
                    case 3:
                        ...
                        state = mission_3_set_straight_and_center1_long(fpga_videodata, WIDTH_CENTER);
                        if (state == 1) {
                            ++step;
                        } else if (state == -1) {
                            mission_3_inverse_mdir();
...
//                        ACTION_ATTACH(2);
                    ...
                    case 2:
                        ...
                        state = default_set_center1_long(fpga_videodata, dir, WIDTH_CENTER + (dir == LEFT ? -30 : 30),
                                                         HEIGHT - 4, BLACK, DEFAULT_CENTER_DISTANCE + (dir == LEFT ? 10 : -10));
                        if (state == -1) {
                            if (++flag == 5) {
                                flag = 0;
                            }
                    ...
                    case 6:
                        if (flag == 0) {
                            default_watch_green(fpga_videodata);
                            ++flag;
                        }
...
//                            RobotSleep(1);
                        ...
                        state = mission_8_1_watch_below(fpga_videodata, 20);
                        if (state == 1) {
                            ++step;
                            flag = 0;
                        }
...
//                        RobotSleep(2);
                    ...
                    case 1:
                        ...
                        setFPGAVideoData(fpga_videodata);
#if MODE == 3
                        state = default_set_straight_and_center1(fpga_videodata, dir, WIDTH_CENTER + (dir == LEFT ? 60 : -60), HEIGHT - 4, BLACK, DEFAULT_CENTER_DISTANCE);
#else
                        state = default_set_straight_and_center1_long(fpga_videodata, dir,
                                                                      WIDTH_CENTER + (dir == LEFT ? 60 : -60),
                                                                      HEIGHT - 4, BLACK, DEFAULT_CENTER_DISTANCE);
#endif
                    ...
                    case 2:
                        ...
                        setFPGAVideoData(fpga_videodata);
#if MODE == 3
                        state = default_set_straight_and_center1(fpga_videodata, dir, WIDTH_CENTER + (dir == LEFT ? 50 : -50), HEIGHT - 4, BLACK, DEFAULT_CENTER_DISTANCE);
#else
                        state = default_set_straight_and_center1_long(fpga_videodata, dir, WIDTH_CENTER + (dir == LEFT ? 30 : -30), HEIGHT - 4, BLACK, DEFAULT_CENTER_DISTANCE);
#endif
                        if (state == 1) {
